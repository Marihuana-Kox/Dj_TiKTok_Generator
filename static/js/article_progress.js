...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function finish(success, msg) {
        ...
        // Разблокируем форму (флаг isBusy сбрасывается в form_module через событие или таймаут, 
        // но лучше вызвать функцию сброса явно, если она доступна, или просто оставить так)
        console.log('🏁 Процесс отслеживания завершен.');
    }
});